...
export const SendButton = (props: SendButtonProps) => {
  return (
    <button
      ...
      {...props}
      class={
        'py-2 px-4 justify-center font-semibold text-white focus:outline-none flex items-center disabled:opacity-50 disabled:cursor-not-allowed disabled:brightness-100 transition-all filter hover:brightness-90 active:brightness-75 hover:scale-125 chatbot-button ' +
        props.class
      }
...
export const DeleteButton = (props: SendButtonProps) => {
  ...
  return (
    <button
      ...
      {...props}
      class={
        `py-2 ${paddingClass} justify-center font-semibold text-white focus:outline-none flex items-center disabled:opacity-50 disabled:cursor-not-allowed disabled:brightness-100 transition-all hover:scale-125 chatbot-button ` +
        props.class
      }
      style={{ background: 'transparent', border: 'none' }}
